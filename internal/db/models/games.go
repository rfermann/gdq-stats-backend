...
type Game struct {
	...
	Runner    string    `boil:"runner" json:"runner" toml:"runner" yaml:"runner"`
...
var GameTableColumns = struct {
	...
	ID:        "games.id",
	StartDate: "games.start_date",
	EndDate:   "games.end_date",
	Duration:  "games.duration",
	Name:      "games.name",
	Runner:    "games.runner",
	EventID:   "games.event_id",
}
...
var GameWhere = struct {
	...
	Runner    whereHelperstring
	EventID   whereHelperstring
}{
	ID:        whereHelperstring{field: "\"games\".\"id\""},
	StartDate: whereHelpertime_Time{field: "\"games\".\"start_date\""},
	EndDate:   whereHelpertime_Time{field: "\"games\".\"end_date\""},
	Duration:  whereHelperstring{field: "\"games\".\"duration\""},
	Name:      whereHelperstring{field: "\"games\".\"name\""},
	Runner:    whereHelperstring{field: "\"games\".\"runner\""},
	EventID:   whereHelperstring{field: "\"games\".\"event_id\""},
}
...
var (
	gameAllColumns            = []string{"id", "start_date", "end_date", "duration", "name", "runner", "event_id"}
	gameColumnsWithoutDefault = []string{"start_date", "end_date", "duration", "name", "runner", "event_id"}
...
func (q gameQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Game, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_models: failed to execute a one query for games")
	}
...
func (q gameQuery) All(ctx context.Context, exec boil.ContextExecutor) (GameSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db_models: failed to assign all query results to Game slice")
	}
...
func (q gameQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to count games rows")
	}
...
func (q gameQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db_models: failed to check if games exists")
	}
...
func (o *Game) Event(mods ...qm.QueryMod) eventQuery {
...
func (gameL) LoadEvent(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGame interface{}, mods queries.Applicator) error {
	var slice []*Game
	var object *Game
...
// SetEvent of the game to the related item.
// Sets o.R.Event to related.
// Adds o to related.R.Games.
func (o *Game) SetEvent(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Event) error {
	var err error
	if insert {
...
func FindGame(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Game, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_models: unable to select from games")
	}
...
func (o *Game) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db_models: no games provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to insert into games")
	}
...
func (o *Game) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db_models: unable to update games, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update games row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by update for games")
	}
...
func (q gameQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update all for games")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to retrieve rows affected for games")
	}
...
func (o GameSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update all in game slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to retrieve rows affected all in update all game")
	}
	return rowsAff, nil
}
...
func (o *Game) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db_models: no Game provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete from games")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by delete for games")
	}
...
func (q gameQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db_models: no gameQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete all from games")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by deleteall for games")
	}
...
func (o GameSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete all from game slice")
	}
...
func (o *GameSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to reload all in GameSlice")
	}
...
func GameExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db_models: unable to check if games exists")
	}
...
func (o *Game) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db_models: no games provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db_models: unable to upsert games, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"games\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to upsert games")
	}
