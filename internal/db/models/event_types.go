...
var EventTypeWhere = struct {
	...
	Description: whereHelperstring{field: "\"event_types\".\"description\""},
}
...
func (r *eventTypeR) GetEvents() EventSlice {
	if r == nil {
		return nil
	}
	return r.Events
...
var (
	eventTypeAllColumns            = []string{"id", "name", "description"}
	eventTypeColumnsWithoutDefault = []string{"name", "description"}
	eventTypeColumnsWithDefault    = []string{"id"}
...
func (q eventTypeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*EventType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_models: failed to execute a one query for event_types")
	}
...
func (q eventTypeQuery) All(ctx context.Context, exec boil.ContextExecutor) (EventTypeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db_models: failed to assign all query results to EventType slice")
	}
...
func (q eventTypeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to count event_types rows")
	}
...
func (q eventTypeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db_models: failed to check if event_types exists")
	}
...
func (o *EventType) Events(mods ...qm.QueryMod) eventQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"events\".\"event_type_id\"=?", o.ID),
	)
...
func (eventTypeL) LoadEvents(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEventType interface{}, mods queries.Applicator) error {
	var slice []*EventType
	...
	query := NewQuery(
		qm.From(`events`),
		qm.WhereIn(`events.event_type_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *EventType) AddEvents(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Event) error {
	var err error
...
func FindEventType(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*EventType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_models: unable to select from event_types")
	}
...
func (o *EventType) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db_models: no event_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to insert into event_types")
	}
...
func (o *EventType) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db_models: unable to update event_types, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update event_types row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by update for event_types")
	}
...
func (q eventTypeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update all for event_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to retrieve rows affected for event_types")
	}
...
func (o EventTypeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to update all in eventType slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to retrieve rows affected all in update all eventType")
	}
	return rowsAff, nil
}
...
func (o *EventType) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db_models: no EventType provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete from event_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by delete for event_types")
	}
...
func (q eventTypeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db_models: no eventTypeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete all from event_types")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_models: failed to get rows affected by deleteall for event_types")
	}
...
func (o EventTypeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_models: unable to delete all from eventType slice")
	}
...
func (o *EventTypeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to reload all in EventTypeSlice")
	}
...
func EventTypeExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db_models: unable to check if event_types exists")
	}
...
func (o *EventType) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db_models: no event_types provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db_models: unable to upsert event_types, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"event_types\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "db_models: unable to upsert event_types")
	}
